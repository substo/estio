...
- Preserve structured CRM display names generated by Paste Lead, such as "Kristina Grüße Lead Sale GF Apt 1+Bdr Paphos €50,000 max"; do not propose "name" just to strip role, goal, requirement, reference, bedroom, property type, location, or budget tokens. Use "firstName" and "lastName" for the clean person name.

...
test("default policies include Northstar lead intake and booking skill", () => {
  assert.equal(
    DEFAULT_SKILL_POLICY_BLUEPRINTS.some((policy) => policy.skillId === "lead_intake_booking" && policy.objective === "book_viewing"),
    true
  );
});

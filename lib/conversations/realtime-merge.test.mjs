...
test("accepts unique out-of-order timestamps for same conversation", () => {
    const state = {
        seenEventIds: new Set(),
        lastTsByConversationId: {},
    };
    ...
    assert.equal(state.lastTsByConversationId.conv_2, new Date("2026-03-09T09:05:00.000Z").getTime());
});

#!/bin/bash
# =============================================================================
# Outlook Sync Cron Job
# =============================================================================
# This script is called by system crontab every 5 minutes to sync Outlook.
#
...
LOG_FILE="${LOG_DIR}/outlook-sync-cron.log"
LOCK_FILE="/tmp/outlook-sync-cron.lock"
...
find "${LOG_DIR}" -name "outlook-sync-cron.log.*" -mtime +7 -delete 2>/dev/null || true
...
# Main execution
log "START: Outlook sync job initiated"
...
CURL_CMD="${CURL_CMD} '${APP_URL}/api/cron/outlook-sync'"
...
log "END: Outlook sync job completed"

...
const LEAD_PARSE_THINKING_BUDGET = 1024;
...
const LeadParsingSchema = z.object({
    contact: z.object({
        ...
        role: z.enum(["Lead", "Owner", "Agent", "Tenant"]).nullable().optional(),
...
async function parseLeadFromTextInternal(
    ...
    try {
        const prompt = [
            ...
            "Set contact.role to exactly one of Lead, Owner, Agent, or Tenant when inferable; otherwise default to Lead.",
            ...
            "1. Role: Must be exactly \"Lead\", \"Owner\", \"Agent\", or \"Tenant\".",
            ...
            "JSON schema:",
            "{",
            '  "contact": { "name": string|null, "firstName": string|null, "lastName": string|null, "role": "Lead"|"Owner"|"Agent"|"Tenant"|null, "phone": string|null, "countryCode": string|null, "email": string|null },',

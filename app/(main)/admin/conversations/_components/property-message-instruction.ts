...
export function buildPropertyMessageInstruction(input: PropertyMessageInstructionInput): string {
    ...
    return [
        ...
        "For a new-listing message, use this mini-story shape: thread-aware hook, 2-3 key facts, one light benefit only if useful, then a clear CTA and the URL on its own line.",
        "Before writing, compare against the recent outbound messages. Do not reuse the same opener, CTA, or phrase pattern from the last property/listing message.",
        "If this is another similar listing after no client reply, make that feel natural and brief instead of acting like a fresh first message.",
        ...
        "Use simple, clear English that is easy for non-native speakers. Avoid idioms or vague phrases such as fancy a look, worth a look, or caught my eye.",
        "Use direct CTAs such as: Would you like the details?, Would you like to view it?, or Should I send you more info? Pick wording that fits the thread and do not repeat the previous CTA.",

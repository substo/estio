...
const defaultInboundTheme = {
    ...
    sharedContactCardClassName: "border-gray-200 bg-gray-50",
    sharedContactAvatarClassName: "bg-blue-100",
    sharedContactAvatarIconClassName: "text-blue-600",
    sharedContactNameClassName: "text-gray-900",
    sharedContactMetaClassName: "text-gray-500",
    sharedContactInfoLinkClassName: "text-gray-600 hover:bg-gray-100",
...
const whatsappOutboundTheme: MessageBubbleTheme = {
    ...
    sharedContactCardClassName: "border-emerald-200 bg-white/65",
    sharedContactAvatarClassName: "bg-emerald-100",
    sharedContactAvatarIconClassName: "text-emerald-700",
    sharedContactNameClassName: "text-slate-900",
    sharedContactMetaClassName: "text-slate-600",
    sharedContactInfoLinkClassName: "text-slate-700 hover:bg-emerald-100/70",
...
const defaultSurfaceTheme: ConversationSurfaceTheme = {
    ...
    timelineClassName: "bg-slate-50/50",
    ...
    composerContainerClassName: "border-t bg-white",
    composerShellClassName: "border bg-white focus-within:ring-2 focus-within:ring-slate-400/20 focus-within:border-slate-300",
    composerControlClassName: "bg-slate-50 hover:bg-slate-100 focus:ring-0",
...
const whatsAppSurfaceTheme: ConversationSurfaceTheme = {
    ...defaultSurfaceTheme,
    channel: "WhatsApp",
    rootClassName: "bg-[#f3f5ee]",
    timelineClassName: "bg-[#f3f5ee]",
    ...
    composerContainerClassName: "border-t border-emerald-100 bg-[#f7faf3]",
    composerShellClassName: "border border-emerald-200 bg-white focus-within:ring-2 focus-within:ring-emerald-500/20 focus-within:border-emerald-300",
    composerControlClassName: "bg-emerald-50 hover:bg-emerald-100 focus:ring-0",
    ...
    suggestedQueueClassName: "border-t border-b border-emerald-100 bg-emerald-50/55",
    ...
    activityPillClassName: "bg-white/85 border-emerald-100",
    activityPillHoverClassName: "hover:bg-emerald-50",
    activityContentClassName: "bg-white/90 border-emerald-100",

...
export function TeamMemberCard({ user, calendars, isAdmin, isCurrentUser }: TeamMemberCardProps) {
    ...
    // ... (rest of action handlers logic is unchanged, I will omit for concise replacement if possible using replace_file_content carefully, but for now I'll just keep the handlers if I'm not replacing them)
    // Wait, I need to replace the component start.

...
const propertySchema = z.object({
    ...
    externalPublicUrl: z.string().optional().nullable(),
    externalPublicUrlSource: z.string().optional().nullable(),
    legacyCrmPropertyId: z.string().optional().nullable(),
...
export async function upsertProperty(formData: FormData, options?: { redirectOnCreate?: boolean }) {
    try {
        ...
        const rawData = {
            ...
            externalPublicUrl: formData.get("externalPublicUrl"),
            externalPublicUrlSource: formData.get("externalPublicUrl") ? (formData.get("externalPublicUrlSource") || "manual") : null,
            legacyCrmPropertyId: formData.get("legacyCrmPropertyId"),
